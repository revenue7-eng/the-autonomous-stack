...
**[Technology Catalog](https://revenue7-eng.github.io/the-autonomous-stack/docs/catalog/)** — 68 technologies evaluated on two axes: Autonomy (A0–A3) and Transparency (T0–T2). Includes both autonomous alternatives and the mainstream services they replace.
...
**[Dependency Graph](https://revenue7-eng.github.io/the-autonomous-stack/docs/dependency-graph.html)** — interactive map of how 68 technologies depend on each other.
