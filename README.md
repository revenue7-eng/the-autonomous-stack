...
- **To understand the philosophy** → read [`docs/philosophy.md`](docs/philosophy.md).
- **To pick a technology** → browse the [`docs/catalog/`](docs/catalog/) (each card includes technical specs and philosophical assessment).
- **To build a complete system** → follow one of the [`docs/recipes/`](docs/recipes/).
