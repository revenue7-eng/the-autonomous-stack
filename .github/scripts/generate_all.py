...
CATEGORY_LABELS = {
    ...
    'applications/household':   ('Applications', 'Household'),
    'applications/search':      ('Applications', 'Search'),
    'applications/reading':     ('Applications', 'Reading'),
    'applications/bookmarks':   ('Applications', 'Bookmarks'),
    'applications/remote-access': ('Applications', 'Remote Access'),
    'applications/news':        ('Applications', 'News & RSS'),
    'applications/downloads':   ('Applications', 'Downloads'),
