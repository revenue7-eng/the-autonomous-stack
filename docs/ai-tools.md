...
<div style="border:2px solid #86efac;border-radius:12px;padding:20px;">
<div style="font-size:20px;margin-bottom:8px;"><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#86efac;margin-right:8px;vertical-align:middle;"></span>Use Local Models</div>
...
<div style="font-size:20px;margin-bottom:8px;"><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#2ea043;margin-right:8px;vertical-align:middle;"></span>Self-Host the Stack</div>
...
<div style="border:2px solid #196c2e;border-radius:12px;padding:20px;">
<div style="font-size:20px;margin-bottom:8px;"><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#196c2e;margin-right:8px;vertical-align:middle;"></span>Full Sovereign AI</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">Runs open-weight models locally (Llama, Qwen, Mistral)</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: cloud inference APIs</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: hosted inference APIs</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: the OpenAI API</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: the ChatGPT interface</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: ChatGPT desktop</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: ChatGPT</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: hosted deep-research agents</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: Google Speech-to-Text, Otter.ai</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: Google TTS</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#888;margin:4px 0;">→ Local alternative to: Midjourney, DALL-E</div>
<div style="font-size:13px;color:#2ea043;font-weight:600;">A3/T2</div>
...
<div style="font-size:12px;color:#666;">→ 147 technologies evaluated</div>
</a>
</div>
