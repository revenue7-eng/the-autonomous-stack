...
### 🔹 Forgejo → `applications/version-control`

**Файл:** `docs/catalog/forgejo.md`
...
|-----------|--------|----------|
| **Pause** | ✅ | No auto‑refresh or infinite feeds; user‑controlled interaction. |
| **Exit** | ✅ | Full data export (repos, issues, wiki). No vendor lock‑in. |
| **Recoverability** | ✅ | Regular backups of repositories and database; rollback possible. |
| **Visibility** | ✅ | Open source, fully transparent architecture. |
| **External Dependencies** | ✅ | None; can run completely offline. |
