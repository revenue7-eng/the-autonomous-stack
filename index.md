...
**→ [Explore the Autonomy Map](https://revenue7-eng.github.io/the-autonomous-stack/docs/autonomy-map.html)** — 139 technologies, 12 constellations.
...
Start with the [Infrastructure Audit](docs/how-to-choose.md). Eight questions --- three structural (can you stop, leave, recover?) and five diagnostic (what holds you inside, where is it heading?). Takes 15 minutes per service.

### I need to choose a specific tool

Browse the [Technology Catalog](docs/catalog/). 139 technologies rated by Autonomy (A0--A3) and Transparency (T0--T2).
